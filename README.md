...
```sh
curl -fsSL https://raw.githubusercontent.com/chao2hang/chaos-code/main/scripts/install.sh | bash -s -- --version 0.2.112
...
```sh
./scripts/install.sh --version 0.2.112
# Windows:
# .\scripts\install.ps1 -Version 0.2.112
```
