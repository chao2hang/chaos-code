...
async fn updates_chat_state_total_tokens_from_response_usage() {
    ...
    local
        .run_until(async {
            ...
            actor.record_response_token_usage(&response_with_usage(150_000), Some(1_500));
            ...
            assert_eq!(prompt.totals.api_duration_ms, 1_500);
            assert_eq!(prompt.totals.decode_duration_ms, 1_000);
