...
///
/// **Must** also refresh `model_providers` / `auth_providers`: catalog keys
/// like `[model."火山/kimi"]` inherit `api_key` + `base_url` from
/// `[model_providers."火山"]`. Omitting providers leaves in-memory
