...
- **`chaos worktree ls`** now works as a short alias for `chaos worktree list`.
...
- **Resumed remote chats** now use the conversation's last model instead of the gateway default.
