...
- **/btw** now works inside `chaos --minimal`, showing answers in the live area and committing them to scrollback on Esc.
...
- **Global rules** from ~/.chaos/rules and compatible vendor homes are now discovered correctly.
