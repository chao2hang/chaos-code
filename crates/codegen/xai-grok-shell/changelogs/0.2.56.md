...
- **chaos sessions delete <id>** command now lets you permanently remove a session from the CLI.
...
- **chaos quit** no longer hangs when background git or network tasks are slow.
