...
- The "Managed by marketplace" link in the Extensions modal is now clickable and underlined.
...
- **chaos --minimal** now aligns the prompt, status bar, and messages flush-left with the welcome card.
