...
- **File links and media** now work for worktree sessions under ~/.chaos/worktrees/.
...
- **Terminal command cards** in remote sessions now correctly settle after foreground bash tasks.
