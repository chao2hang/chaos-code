...
- **chaos doctor** now shows standalone terminal, tmux, clipboard, and keyboard diagnostics without starting the TUI.

## Bug Fixes

- **Image paste** over chaos wrap now works on headless remotes.
