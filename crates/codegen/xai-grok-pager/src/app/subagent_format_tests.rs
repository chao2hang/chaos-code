...
fn activity_label_rendered_for_each_turn_activity() {
    ...
    let cases: Vec<(TurnActivity, String)> = vec![
        (TurnActivity::Thinking, "思考中".into()),
        (TurnActivity::Responding, "回复中".into()),
        (TurnActivity::AutoCompacting, "压缩中".into()),
        (
