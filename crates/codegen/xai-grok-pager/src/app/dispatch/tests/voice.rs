...
/// A free-tier user hitting the voice keybinding gets the Provider upsell instead of a doomed voice session.
...
fn voice_keybinding_on_restricted_tier_opens_upsell() {
    ...
    assert!(
        ...
        "restricted-tier voice keybinding must open the Provider upsell"
    );
    assert!(
        !app.voice_listening(),
