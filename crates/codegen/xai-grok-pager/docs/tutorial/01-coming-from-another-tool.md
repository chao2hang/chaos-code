...
Fear not — your settings, rules, and skills come with you. Chaos
...
Run **`chaos inspect`** in a repo to see every rules file, skill, and MCP
server Chaos picked up, tagged with where it came from. Each compat source
