...
const NPM_PACKAGE: &str = "chaos-cli";
pub const GH_RELEASE_REPO: &str = "chaos-code/chaos";

/// Primary CLI base URL: GitHub Releases for Chaos updates.
pub(crate) const CLI_BASE_URL_PRIMARY: &str = "https://github.com/chaos-code/chaos/releases";

/// Fallback CLI base URL: same as primary (single source for now).
pub(crate) const CLI_BASE_URL_FALLBACK: &str =
    "https://github.com/chaos-code/chaos/releases";
